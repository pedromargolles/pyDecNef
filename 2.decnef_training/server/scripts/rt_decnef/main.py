...
while True:
    ...
    # decoding of those volumes within H.R.F. peak. Check Trial class in modules.classes.classes for
    # more details.
    ...
    if shared_instances.new_trial.trial_idx != None: # With the first indexed trial, start showing experimental info in console
        ...
        print(Fore.YELLOW + f'Is this volume within H.R.F. Peak ({Exp.HRF_peak_onset}-{Exp.HRF_peak_offset} seconds from trial onset):', new_vol.in_HRF_peak)
        print(Fore.YELLOW + f'Has H.R.F. peak already ended for this trial?:', shared_instances.new_trial.HRF_peak_end)
        print(Fore.YELLOW + f'Number of volumes within H.R.F. peak interval in this trial:', shared_instances.new_trial.n_HRF_peak_vols)
